                ...
                <div className="card">
                  ...
                  <div className="cb">
                    ...
                    <div className="form-row" style={{marginBottom:10}}>
                      ...
                      <textarea className="input" value={optPrompt} onChange={e=>setOptPrompt(e.target.value)} style={{minHeight:100,resize:"vertical" as const}} placeholder={"Paste the agent's system prompt here.\n\nLeave blank to analyze based on live token_usage DB stats for the selected agent."}/>
                    </div>
                    <div className="form-row" style={{marginBottom:14}}>
                      <label className="form-label">Memory / Context Injected (optional)</label>
                      <textarea className="input" value={optMemory} onChange={e=>setOptMemory(e.target.value)} style={{minHeight:60,resize:"vertical" as const}} placeholder="Paste any memory or context block injected into this agent..."/>
                    </div>
